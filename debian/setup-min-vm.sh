#!/usr/bin/env bash
# Debian 13 minimal VM bootstrap — CLI dev toolchain only (no GUI)
# Use this for Lima VMs / headless dev VMs. For bare-metal desktops use setup.sh.
# Usage: bash debian/setup-min-vm.sh
set -euo pipefail
